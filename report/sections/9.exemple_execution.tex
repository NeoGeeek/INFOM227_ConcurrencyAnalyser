...
La variable \texttt{a} est accédée en écriture à la fois dans le thread principal ($t_1$ à la ligne 8) et dans le thread ($t_2$ à ligne 2 de la fonction \texttt{increment}).

C'est donc pour ça, que nous envoyons un flag (avertissement) à la ligne 8 dans le tableau ci-dessus.
