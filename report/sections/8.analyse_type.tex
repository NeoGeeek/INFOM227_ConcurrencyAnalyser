...
Comme cité dans la descrition, l'analyse réalisée dans ce projet est une analyse \textit{forward}.
...
C'est donc pour ça que nous avons choisi une analyse \textit{forward} pour notre outil d'analyse et non pas un autre type d'analyse comme \textit{backward}.
