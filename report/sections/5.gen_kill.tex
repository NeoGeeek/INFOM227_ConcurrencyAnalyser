...
Cette approche nous permet de suivre les accès en lecture ou en écriture des variables.

Nous avons décidé d'implémenter deux ensembles GEN/KILL, un destiné à l'accès en lecture, l'autre pour l'écriture.
...
Lorsque nous rencontrons un accès en lecture, nous ajoutons cet accès au premier ensemble, étant donné qu'il n'y a aucun accès en écriture.\\
Inversement, lorsqu'un accès en écriture est rencontré, nous ajoutons cet accès au second ensemble.\\
Cependant, si un accès en écriture et un accès en lecture sont détectés, nous ajoutons aux deux ensembles, et la variable passe dans un état \textit{Read+Write}.\\
