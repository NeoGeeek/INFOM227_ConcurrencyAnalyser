...
Dans ce simple exemple, nous illustrons la \textit{soundness} de notre analyse en montrant qu’aucun accès dangereux est ignoré.
...
Ainsi, les choix de conception de notre analyse garantissent que toute situation dangereuse réelle est détectée, ce qui en fait une analyse \textit{sound}.
